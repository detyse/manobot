...
from manobot.agents.registry import AgentRegistry, AgentStatus, get_registry
...
class AgentPool:
    ...
    async def _create_agent(self, agent_id: str) -> AgentLoop:
        ...
        # Override memory dir to agent-specific location
        memory_store.memory_dir = memory_dir
